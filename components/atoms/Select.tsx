                ...
                {options.map((option) => (
                  <Listbox.Option
                    ...
                    className={twMerge(
                      ...
                      "ui-active:ui-not-selected:bg-accent-subtle data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
                      multiple
                        ? "ui-selected:bg-accent-subtlest ui-selected:hover:bg-accent-subtle"
                        : "ui-selected:bg-accent ui-selected:text-onaccent"
                    )}
                  >
