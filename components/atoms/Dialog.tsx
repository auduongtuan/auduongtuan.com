  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        ...
        <HDialog.Panel className={`w-full max-w-md flex flex-col border-solid border border-black/20 rounded-xl overflow-hidden translate-z-0 shadow-lg`}>
          ...
          <main className="bg-white flex-grow-0">{children}</main>
        </HDialog.Panel>
      </div>
      </Transition.Child>
    </HDialog>
