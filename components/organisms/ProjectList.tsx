...
export default function ProjectList({projects}:{projects:Project[]}) {
  ...
  return (
      <section id="works">
        <div className="main-container py-10 md:py-16 lg:py-24 opacity-0 animate-fade-in-fast animation-delay-400">
          <aside className="fixed transition-opacity ease-linear animate-bounce hidden lg:block" style={{bottom: `${scrollPosition/1.4}px`, opacity: (scrollPosition >= 300) ? 0 : (300-scrollPosition)/300}}>
            <div className='text-2xl text-blue-900 -translate-y-32 -translate-x-40 -rotate-90' ><div className=''>← Selected works</div></div>
          </aside>
