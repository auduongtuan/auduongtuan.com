  ...
  return (
    ...
    <div className="grid grid-cols-12 gap-x-6 gap-y-0 md:gap-y-16 lg:gap-y-24">
      ...
      <div className="grid grid-cols-2 gap-6">
        <div>
          <h3 className="font-sans font-semibold">Work</h3>
         <p className="body-text mt-content-node">Currently, I am digging into Typescript and some advanced React Hooks. Meanwhile, figure out how to build Figma plugins to help design process in my company.</p>
        </div>
        <div>
          <h3 className="font-sans font-semibold">Life</h3>
          <ul className="body-text mt-content-node list-disc list-inside">
