...
roles:
  ["WordPress Development", "Front-end Development", "Web Design (support)"]
coolness: 15
tools: ["Sketch", "Gulp, Rollup, SWC", "WordPress", "TailwindCSS", "jQuery"]
...
<Grid>
  <Col spanLg="6">
    <EmojiBox emoji="✍️" caption="Easier to manage content."></EmojiBox>
  </Col>
  <Col spanLg="6">
    <EmojiBox emoji="🎨" caption="Better content and design."></EmojiBox>
  </Col>
</Grid>
