...
coolness: 30
half: true
tools: ["Figma", "ReactJS", "styled-components", "React Hook Form"]
---
...
<Grid>
  ...
  <Col spanLg="4">
    <EmojiBox
      emoji="ℹ"
      caption="Make sure signatures contain needed information"
    ></EmojiBox>
  </Col>
  <Col spanLg="4">
...
<ContentNode>
  <Note>
    - Name - Role - Email Address - Office Location: - With USA Location ⇒ Add
    default office number and make mobile phone number optional. - With VN
    Location ⇒ Make phone number the default and add optional office number. -
...
<Image
  src="instruction-ios.jpg"
  alt="Instruction on iOS"
  width={1600}
  height={1600}
/>
...
<Image
  src="instruction-android.jpg"
  alt="Instruction on Android"
  width={1600}
  height={1600}
/>
