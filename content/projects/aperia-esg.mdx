...
<Grid>
  <Col spanLg="4">
  <EmojiBox emoji="☑️" caption="Enhance signatures' consistency"></EmojiBox>
  </Col>
  <Col spanLg="4">
  <EmojiBox emoji="ℹ" caption="Make sure signatures contain needed information"></EmojiBox>
  </Col>
  <Col spanLg="4">
  <EmojiBox emoji="📜" caption="Instruct to setup signatures"></EmojiBox>
  </Col>
</Grid>
